    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Commission Breakdown <span
                        class="text-gray-500 font-normal"></span></h2>
            </div>
            <div class="card bg-white px-6">
                            ...
                            <div class="flex items-start gap-4 flex-1">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Total transaction: ${{ number_format($payment['total_amount'], 2) }}
                                    </p>
                                </div>
                            </div>
