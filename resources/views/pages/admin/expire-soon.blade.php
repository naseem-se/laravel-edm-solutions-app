...
@section('title')
    Compliance Center - Expiring Soon
@endsection
    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Expiring Soon (Next 30 Days)</h2>
            </div>
                ...
                <table class="w-full">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Days Remaining</th>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex flex-col">
                                    <span class="text-sm font-semibold text-yellow-600">{{ $remainingDays }} days</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium inline-flex items-center gap-1.5">
