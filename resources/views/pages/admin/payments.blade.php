        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Facility Payment Invoices <span
                        class="text-gray-500 font-normal">{{ $invoiceCount }}</span></h2>
            </div>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-sm font-medium text-gray-900">{{ $invoice['facility_name'] }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="text-sm font-bold text-gray-900">${{ $invoice['amount'] }}</span>
                            </td>
                            <td class="px-6 py-4">
