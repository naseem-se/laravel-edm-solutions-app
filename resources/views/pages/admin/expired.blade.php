    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">Expired Credentials</h2>
            </div>
                ...
                <table class="w-full">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Days Overdue</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">{{ $document->created_at->copy()->addYear()->format('Y-m-d') }}</td>
                            <td class="px-6 py-4">
                                @php
                                ...
                                @endphp
                                <div class="flex">
                                    <span class="tpx-6 py-4 text-sm text-red-600 font-semibold">{{ abs($remainingDays) }} days</span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <span
                                    class="px-3 py-1 bg-red-100 text-red-700 rounded-full text-xs font-medium inline-flex items-center gap-1.5">
