    ...
    <main class="flex-1 p-4 lg:p-6 overflow-auto bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div
                ...
                <div class="text-sm text-gray-600">
                    +${{ $earningsIncrease }} since last month
                </div>
            </div>
            ...
            <div
                ...
                <div class="text-sm text-gray-600">
                    From {{ $pendingInvoiceCount }} invoices
                </div>
            </div>
        ...
        <div class="overflow-x-auto border border-gray-200 rounded-xl bg-white shadow-sm">
            <div class="p-6 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-800">User Payout Schedule <span
                        class="text-gray-500 font-normal">{{ $payoutCount }}</span></h2>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Payout ID</th>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">Shifts Completed</th>
                            ...
                            <tr class="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-semibold text-gray-900">{{ $payout['payout_id'] }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white text-sm font-semibold">
                                            {{ $payout['user_initials'] }}
                                        </div>
                                        <span class="text-sm font-medium text-gray-900">{{ $payout['user_name'] }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
                                        {{ $payout['shifts_completed'] }} shifts
                                    </span>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 text-center">
                                    <button class="p-2 hover:bg-gray-100 rounded-lg transition-colors" title="Download payout">
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                                    <p class="text-sm">No payouts found</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
