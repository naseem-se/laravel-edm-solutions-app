...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 font-sans overflow-hidden">
                ...
                <div class="space-y-1">
                    ...
                    <div>
                        ...
                        <div x-show="openShifts" x-transition:enter="transition ease-out duration-200"
                            ...
                            <a href="{{ route('admin.open.shifts') }}"
                                class="flex items-center px-3 py-2 text-gray-300 hover:text-white text-sm rounded-lg hover:bg-white/5 transition-all duration-200">
                    ...
                    <!-- Compliance -->
                    <a href="{{ route('admin.compliances.index') }}"
                        class="flex items-center px-3 py-2.5 {{ Request::routeIs('admin.compliances.*') ? 'bg-[#3d5a9e]' : 'hover:bg-white/5' }} text-white hover:bg-white/5 rounded-lg transition-all duration-200">
                    ...
                    <a href="{{ route('admin.timesheet.index') }}"
                        class="flex items-center px-3 py-2.5 {{ Request::routeIs('admin.timesheet.*') ? 'bg-[#3d5a9e]' : 'hover:bg-white/5' }} text-white hover:bg-white/5 rounded-lg transition-all duration-200">
                        <i class="fas fa-clipboard-check w-4 text-sm mr-3"></i>
                    ...
                    <a href="{{ route('admin.audit.logs') }}"
                        class="flex items-center px-3 py-2.5 {{ Request::routeIs('admin.audit.logs') ? 'bg-[#3d5a9e]' : 'hover:bg-white/5' }} text-white hover:bg-white/5 rounded-lg transition-all duration-200">
                    ...
                    <a href="{{ route('admin.setting.index') }}"
                        class="flex items-center px-3 py-2.5 {{ Request::routeIs('admin.setting.*') ? 'bg-[#3d5a9e]' : 'hover:bg-white/5' }} text-white hover:bg-white/5 rounded-lg transition-all duration-200">
    ...
    <script>
        ...
        function dismissToast(type) {
            const toast = type === 'success' ? document.getElementById('toast-success') : document.getElementById('toast-error');
    ...
    @if (session('success'))
        <div id="toast-success" 
            class="fixed top-4 right-4 flex items-center gap-3 bg-green-50 border border-green-200 shadow-lg text-green-800 px-4 py-3 rounded-lg "
            style="z-index: 9999;">
            <!-- Icon -->
            ...
            <!-- Close Button -->
            <button onclick="dismissToast('success')" class="text-green-400 hover:text-green-600 ml-auto flex-shrink-0">&times;</button>
        </div>
        <script>
            setTimeout(() => {
    ...
    @if (session('error'))
        <div id="toast-error" 
            class="fixed top-4 right-4 flex items-center gap-3 bg-red-50 border border-red-200 shadow-lg text-red-800 px-4 py-3 rounded-lg"
            style="z-index: 9999;">
            <!-- Icon -->
            ...
            <!-- Close Button -->
            <button onclick="dismissToast('error')" class="text-red-400 hover:text-red-600 ml-auto flex-shrink-0">&times;</button>
        </div>
        <script>
            setTimeout(() => {
                dismissToast('error');
